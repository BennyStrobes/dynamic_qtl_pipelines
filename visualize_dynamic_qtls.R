...
real_data <- read.table(real_merged_results,header=TRUE, sep = "\t")
...
qq_plot_cmp_true_to_uniform(real_data$pvalue, output_file)


output_file <- paste0(qtl_visualization_dir, parameter_string, "_qq_plot_cmp_to_uniform.png")
qq_plot_cmp_to_uniform(real_data$pvalue, perm_data$pvalue, output_file)

#############################
# QQ-plot showing real and permuted compared to uniform
#############################
output_file <- paste0(qtl_visualization_dir, parameter_string, "_qq_plot_real_vs_permuted.png")
qq_plot_real_vs_permuted(real_data$pvalue, perm_data$pvalue, output_file)
