#!/bin/bash
#SBATCH --time=3:00:00 --partition=gilad --mem=5GB
...
#Rscript visualize_significant_hits.R $mod_parameter_string $qtl_visualization_dir "/project2/gilad/bstrober/ipsc_differentiation/dynamic_qtl_pipelines/ipsc_data_te/temper_debug/te_round_genotype_sample_null_.01/"
