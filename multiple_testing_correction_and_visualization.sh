...
if false; then
python organize_significant_hits_covariate.py $mod_parameter_string $qtl_results_dir $joint_test_input_file $correction_factor_file $qtl_visualization_dir $parameter_string $target_region_input_file $covariate_method
fi

Rscript visualize_significant_hits.R $mod_parameter_string $qtl_visualization_dir "/project2/gilad/bstrober/ipsc_differentiation_19_lines/dynamic_qtl_pipelines/ipsc_data_te/qtl_visualization/hit_viz_te_log_linear_cell_line_pc1_3/"



# python organize_significant_hits_null.py $mod_parameter_string $qtl_results_dir $joint_test_input_file $correction_factor_file $qtl_visualization_dir $parameter_string $target_region_input_file


# Rscript visualize_significant_hits.R $mod_parameter_string $qtl_visualization_dir "/project2/gilad/bstrober/ipsc_differentiation/dynamic_qtl_pipelines/ipsc_data_te/temper_debug/te_quadratic_basis_round_genotype_null_hits/"
