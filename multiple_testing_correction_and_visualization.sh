...
echo "Starting hit visualization"
python organize_significant_hits.py $mod_parameter_string $qtl_results_dir $joint_test_input_file $qtl_hit_viewer_dir $min_num_biallelic_lines $min_num_biallelic_samples $min_num_het_test_variant_biallelic_samples $parameter_string $target_region_input_file

module unload Anaconda3



Rscript visualize_significant_hits.R $mod_parameter_string $qtl_hit_viewer_dir
